...
- **Tema Romantis:** Dengan tema gelap dan romantis, supaya kamu merasa nyaman curhat dengan suasana yang cozy.
- **Gif Lucu:** Setiap kamu curhat, bakal muncul gif lucu yang bikin suasana hati jadi lebih ringan! 😄

## Cara Menjalankan
1. **Clone repository ini**
   ```bash
   git clone https://github.com/username/curhatin-aku.git
   cd curhatin-aku
